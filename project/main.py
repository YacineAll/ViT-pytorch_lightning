...
from lightning_modules import CIFAR10DataModule, LitClassifierModel
...
def cli_main():
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_acc',
        dirpath=f"{args.data_path}/lightning_logs",
    ...
    # testing
    # ------------
    result = trainer.test(model=model, data_module=data_module)
